            ...
            <div className="bg-[#121212] border border-gray-800 rounded-none shadow-2xl max-w-md w-full p-8 pointer-events-auto relative overflow-hidden" style={{ cursor: 'default' }}>
              ...
              <div className="relative z-10 text-center">
                ...
                <motion.div
                  ...
                  className={`bg-gradient-to-r ${colors.bg} rounded-none p-8 mb-6 border-2 ${colors.border} relative overflow-hidden`}
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <p className={`${colors.text} text-sm mb-2 uppercase tracking-wider`}>{reward.rarity}</p>
                    <h3 className="text-2xl font-bold text-white mb-2">{reward.name}</h3>
                    <p className="text-white/80 text-sm">{reward.type}</p>
                    {reward.value && (

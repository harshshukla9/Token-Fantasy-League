      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="card mb-8">
          <div className="flex items-start space-x-6">
            {/* Avatar */}
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center text-4xl font-bold text-black">
        ...
        <div className="card mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className={`p-4 rounded-lg text-center ${profile.score >= 100 ? 'bg-gray-800 border border-gray-600' : 'bg-gray-900 opacity-50 border border-gray-800'}`}>
              <div className="text-4xl mb-2">🥉</div>
              <p className="text-sm font-semibold text-warm-white">Bronze</p>
              <p className="text-xs text-gray-400">100+ points</p>
            </div>

            <div className={`p-4 rounded-lg text-center ${profile.score >= 500 ? 'bg-gray-800 border border-gray-600' : 'bg-gray-900 opacity-50 border border-gray-800'}`}>
              <div className="text-4xl mb-2">🥈</div>
              <p className="text-sm font-semibold text-warm-white">Silver</p>
              <p className="text-xs text-gray-400">500+ points</p>
            </div>

            <div className={`p-4 rounded-lg text-center ${profile.score >= 1000 ? 'bg-gray-800 border border-gray-600' : 'bg-gray-900 opacity-50 border border-gray-800'}`}>
              <div className="text-4xl mb-2">🥇</div>
              <p className="text-sm font-semibold text-warm-white">Gold</p>
              <p className="text-xs text-gray-400">1,000+ points</p>
            </div>

            <div className={`p-4 rounded-lg text-center ${profile.rank <= 10 ? 'bg-gray-800 border border-gray-600' : 'bg-gray-900 opacity-50 border border-gray-800'}`}>
              <div className="text-4xl mb-2">👑</div>
